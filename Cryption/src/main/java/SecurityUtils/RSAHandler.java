...
import static SecurityUtils.RSAUtils.encodeBase64;
...
public class RSAHandler {
     ...
     */
    public static String generateSign(RSAPrivateKey privateKey, String text) throws Exception {
        //初始化数字签名对象
     ...
     * @throws Exception RSA异常、MD5异常
     */
    public static boolean verifySign(RSAPublicKey publicKey, String sign, String text) throws Exception {
        //初始化数字签名对象
        Signature signature = Signature.getInstance("MD5withRSA");
